...
print("mse_test_set: ", mean_squared_error(y_test[:, 0], predicted_on_X_test[:, 0]))
...
#print("mse_test_set: ", mean_squared_error(y_test, predicted_on_X_test))
print("mse_test_set: ", mean_squared_error(y_test[:, 1], predicted_on_X_test[:, 1]))
...
#print("mse_test_set: ", mean_squared_error(y_test, predicted_on_X_test))
print("mse_test_set: ", mean_squared_error(y_test[:, 2], predicted_on_X_test[:, 2]))
...
#print("mse_test_set: ", mean_squared_error(y_test, predicted_on_X_test))
print("mse_test_set: ", mean_squared_error(y_test[:, 3], predicted_on_X_test[:, 3]))
...
#print("mse_test_set: ", mean_squared_error(y_test, predicted_on_X_test))
print("mse_test_set: ", mean_squared_error(y_test[:, 4], predicted_on_X_test[:, 4]))
print()
